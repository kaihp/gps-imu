 ...
 * Modified from log_stm32.c for STM32L for Raspberry Pi 3 by
 * Kai Harrekilde-Petersen, 2017/11/19.
...
/**
 *  @defgroup Raspberry_Pi_System_Layer RPI System Layer
 *  @brief  RPI3 System Layer APIs.
 *          To interface with any platform, eMPL needs access to various
 *          system layer functions.
 *
 *  @{
 *      @file   log_rpi3.c
 *      @brief  Logging facility for the Raspberry Pi 3.
 */
